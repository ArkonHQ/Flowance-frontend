...
export const ProjectGridCard = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col gap-3 p-4 rounded-xl border bg-background backdrop-blur-md transition-all hover:shadow-md hover:border-border/60",
        project.isArchived ? "opacity-60 border-dashed" : "border-border/40"
      )}
    >
